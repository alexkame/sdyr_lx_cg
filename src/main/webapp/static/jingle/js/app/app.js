    ...
    var run = function(){
        ...
        Jingle.launch({
            ...
            remotePage : {
                ...
                '#njsb_section':ctx + '/mzb/mzbYearcheck/uncheck', //今年年检公示
                '#gyct_section':ctx + '/mzb/mzbGongyct', //公益创投
                '#fcsq_section':ctx + '/mzb/mzbFucsq', //扶持申请
                '#jnpx_section':ctx + '/mzb/mzbJnpxMain', //技能培训
                '#mzbJnpx_content_section':ctx + '/mzb/mzbJnpxMain/form', //技能培训
                '#mzbJnpx_test_section':ctx + '/mzb/mzbJnpxMain/test', //技能培训
                '#fcsqsave_section':ctx + '/mzb/mzbFucsq/save', //扶持申请
                '#mzbFucsq_view_section':ctx + '/mzb/mzbFucsq/view', //年检公示详情页
                '#mzbGongyct_view_section':ctx + '/mzb/mzbGongyct/view', //年检公示详情页
                '#mzbUnitinfo_view_section':ctx + '/mzb/mzbUnitinfo/view', //基本信息
                '#mzbYearcheck_view_section':ctx + '/mzb/mzbYearcheck/view', //年检公示详情页
                '#oaNotify_view_section':ctx + '/oa/oaNotify/view'
...
//查看机构组织的通告的阅读情况
App.page('oaNotify_view',function(){

    this.init = function(){
        $('#btn_oaNotify_look').tap(function(){
            J.popup({
                tplId : 'popup_oaNotify_look',
                pos : 'top'
            })
        })
    }
