...
<section id="mzbFucsq_view_section" data-transition="flip">
    <header>
        <nav class="left">
    ...
    <article class="active" >
        <form:form id="inputForm" modelAttribute="mzbFucsq" action="${ctx}/mzb/mzbFucsq/save" method="post" class="input-group">
            <div class="input-row">
                <label >标题：</label>
           ...
           <div class="input-row">
            ...
            <div class="input-row">
                ...
                <sys:ckfinder input="files" type="files" uploadPath="/mzb/mzbFucsq" selectMultiple="true" readonly="true" />
            </div>
        ...
        <%----%>
       <%--<form:form id="inputForm" modelAttribute="mzbFucsq"  method="post" class="input-group">--%>
            <%--<div class="input-row">--%>
                <%--<label>年度:</label>--%>
