...
<div id="content">
	<div class="container">
		...
		<form id="login"  action="${ctx}/login" method="post">
			<div id="login_header"><i class="icon-home"></i>海沧民政百事通</div>
			<div id="login_content">
                    <span>
						<input  type="text" id="username" name="username" class="tip" value="${username}" onclick="onClick(this);" onblur="onBlur(this);">
                        <label for="username" style=" color: black;">登录名</label>
                        <i class="icon-user"></i>
                        <div class="tooltip" data-text="填写您的社会组织名称">填写您的社会组织名称</div>
                    </span>
