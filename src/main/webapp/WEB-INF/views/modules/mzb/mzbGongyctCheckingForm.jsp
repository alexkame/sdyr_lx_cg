...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/mzb/mzbGongyct/">公益创投列表</a></li>
	...
	<form:form id="inputForm" modelAttribute="mzbGongyct" action="${ctx}/mzb/mzbGongyct/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="summary" htmlEscape="false" rows="4" maxlength="255" class="input-xxlarge " readonly="true"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">申请金额：</label>
			<div class="controls">
				<form:input path="cash" htmlEscape="false" maxlength="255" class="input-xlarge  number" readonly="true"/>
			</div>
		</div>
		...
		<div class="form-actions">
				<input  class="btn btn-primary" type="submit" onclick="$('#status').val('2');" value="通过"/>&nbsp;
				<input  class="btn btn-danger" type="submit" onclick="$('#status').val('1');" value="不通过"/>&nbsp;
		</div>
	</form:form>
</body>
</html>